-- Repetición MENSUAL para eventos personales (mismo día del mes).
-- 1) Constraint acepta 'monthly'. 2) get_available_starts la bloquea.
  ...
  WHILE v_date <= v_end_date LOOP
    ...
    LOOP
      ...
      LOOP
        ...
        -- Eventos personales: puntuales, diarios, semanales y mensuales
        IF v_busy_end IS NULL THEN
          ...
          WHERE e.business_id = p_business_id
            ...
            AND (
              ...
              OR (
                e.recurrence IN ('daily', 'weekly', 'monthly')
                AND (
                  e.recurrence = 'daily'
                  OR (
                    e.recurrence = 'weekly'
                  ...
                  OR (
                    ...
                    AND EXTRACT(DAY FROM (e.start_at AT TIME ZONE 'America/Montevideo'))::integer
